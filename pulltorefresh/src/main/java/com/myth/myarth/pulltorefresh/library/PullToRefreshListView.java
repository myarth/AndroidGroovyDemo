...
import com.myth.myarth.pulltorefresh.library.internal.EmptyViewMethodAccessor;
...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    public void withLoadMoreView(Context context) {
        if (footerView == null) {
            footerView = View.inflate(context, R.layout.layout_load_more, null);
